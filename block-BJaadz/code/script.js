...
for (let i = 0; i < allHrsArray.length; i++){
  allHrsArray[i].style.borderRadius = "5px";
}
...
let hrImageClass = document.querySelectorAll('hr[class = image]');
hrImageClass.forEach(elm => elm.style.border = "2px solid purple");
// Hide the box number 17 (last box).
for (let el of document.getElementsByClassName("seventeen")) el.style.visibility = 'hidden';
...
for (let el of document.getElementsByClassName("one")) el.remove();
// Replace all the elements inside box 1 with the para (you created above)
for (let el of document.getElementsByClassName("one")) el.append(para);
/* Walking the DOM
...
para1.innerText = "Append inserts as last child";
for (let el of document.getElementsByClassName("two")) el.append(para1);
...
for (let el of document.getElementsByClassName("three")) el.prepend(para2);
// Change the border of box 4 to '1px solid black'
document.getElementsByClassName("four").style.border = '1px solid black';
// Change the border radius of box 5 to 10px.
document.getElementsByClassName("five").style.borderRadius = "10px";
